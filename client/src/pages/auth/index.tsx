...
const Auth = () => {
    ...
    const handleLogin = async () => {
        if (validateLogin()) {
            const response = await apiClient.post<IUser>(LOGIN_ROUTE, {email, password}, {withCredentials: true})
            if (response.data.id) {
    ...
    return (
        <div className="h-[100vh] w-[100vw] flex items-center justify-center">
            <div className="h-[100vh] lg:h-[95vh] sm:w-[80vw] md:w-[90vw] xl:w-[60vw] lg:w-[70vw] bg-white border-2 border-white text-opacity-90 shadow-2xl rounded-3xl grid xl:grid-cols-2">
                <div className="flex flex-col gap-10 items-center justify-center">
                    <div className="flex items-center justify-center flex-col">
                        <div className="flex items-center justify-center">
                            <h1 className="text-4xl font-bold md:text-6xl">Welcome</h1>
                            <img src={Victory} alt="" className="w-[100px]" />
                        </div>
                        <p className="md:font-medium text-center text-xl">
                    ...
                    <div className="flex items-center justify-center w-full">
                        <Tabs className="w-3/4" defaultValue="login">
                            ...
                            <TabsContent className="flex flex-col gap-5 mt-10" value="login">
                                ...
                                />
                                <Button className="rounded-full p-6 bg-black text-white hover:bg-gray-900" onClick={handleLogin}>Login</Button>
                            </TabsContent>
                            ...
                            <Input 
                                ...
                                />
                                <Button className="rounded-full p-6 bg-black text-white hover:bg-gray-900" onClick={handleSignUp}>Sign Up</Button>
                            </TabsContent>
                        </Tabs>
                    </div>
                </div>
